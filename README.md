...
&#8594; Model packages used: (<a href="https://scikit-learn.org/"> Scikit-learn <\a> (for AdaBoost, Linear Discriminant Analysis, Decision Tree Classifier, Gradient Boosting, KNN, Naive Bayes, Random Forest, Logistic Regression and SVM classifiers + cross-validation model selection), <a href="https://pytorch.org/">PyTorch (for neural network models) and <a href="https://xgboost.readthedocs.io/en/stable/python/">XBGoost (for xgboost model)<\a>. <br>
